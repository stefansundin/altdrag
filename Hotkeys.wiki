...
You can find these hex values over at [http://msdn.microsoft.com/en-us/library/dd375731(VS.85).aspx this MSDN page]. To add a key, simply append its hex value to the list. Even though there are hex values for mouse buttons listed on that page, they will not work!
