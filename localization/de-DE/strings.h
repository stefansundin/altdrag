...
struct strings de_DE = {
 ...
 { /* input tab */
   { /* mouse */
     ...
     /* mb5            */ L"Maustaste 5:",
     /* scroll         */ L"Scrollrad:",
     /* more           */ L"Wenn Sie eine gute Idee für einen weiteren Mausbefehl haben, erstellen Sie einen Vorschlag <a href=\"http://code.google.com/p/altdrag/issues/list\">auf der Webseite</a>!",
   },
   { /* actions */
