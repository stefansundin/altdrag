...
if [[ $1 == "all" ]]; then
	...
	eval "$prefix32""gcc -o bin/hooks.dll hooks.c bin/hooks.o -mdll -lshlwapi -lcomctl32 -lpsapi -lole32 -ldwmapi -O2 -s"
	...
	if [[ $x64 == "1" ]]; then
		...
		eval "$prefix64""gcc -o bin/hooks_x64.dll hooks.c bin/hooks_x64.o -mdll -lshlwapi -lcomctl32 -lpsapi -ldwmapi -O2 -s"
	...
	eval "$prefix32""gcc -o hooks.dll hooks.c bin/hooks.o -mdll -lshlwapi -lcomctl32 -lpsapi -lole32 -ldwmapi -g -DDEBUG"
	...
	if [[ $x64 == 1 ]]; then
		...
		eval "$prefix64""gcc -o hooks_x64.dll hooks.c bin/hooks_x64.o -mdll -lshlwapi -lcomctl32 -lpsapi -lole32 -ldwmapi -g -DDEBUG"
	fi
